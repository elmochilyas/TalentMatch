...
- Offer show ranks completed scored candidates by score descending
- Candidates without score appear after scored candidates
- Guest cannot access comparison page
- User cannot compare candidates from another user's offer
- User cannot compare candidates from different offers
- User can compare two completed analyses from their own offer
- Comparison page displays both candidates' saved data
- Comparison page shows conclusion section
- `compareCandidates` tool returns saved comparison data
- `compareCandidates` tool refuses unsafe comparison (different offers, non-completed, not found)
