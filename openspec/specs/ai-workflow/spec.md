...
Document the complete AI pipeline in `docs/ai-workflow.md` — from candidate CV submission through validation, job dispatch, queue processing, AI provider call, structured JSON parsing, database storage, and UI display — including edge case handling and test mocking strategies.
