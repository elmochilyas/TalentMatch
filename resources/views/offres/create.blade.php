                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('offres.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="titre" type="text" name="titre" value="{{ old('titre') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
                            @error('titre')
                        ...
                        <div class="mb-4">
                            ...
                            <input id="competences_requises" type="text" name="competences_requises" value="{{ old('competences_requises') }}" placeholder="PHP, JavaScript, Laravel" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
                        ...
                        <div class="mb-4">
                            ...
                            <input id="niveau_experience_minimum" type="number" name="niveau_experience_minimum" value="{{ old('niveau_experience_minimum') }}" min="0" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" />
